...
#define reserve __NR_set_reserve
...
//    printf("\nTID is: %ld\n",gettid());
    ...
    r_C.tv_nsec = (long)(C%1000)*1000000;
    r_C.tv_sec = C/1000;
    r_T.tv_nsec = (long)(T%1000)*1000000;
    r_T.tv_sec = T/1000;

    //syscall(reserve, gettid(), &r_C, &r_T, cpuid); 
